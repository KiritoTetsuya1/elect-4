  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.tabs}>
        ...
        <span style={styles.activeTab}>Today</span>
        <span style={styles.tab}>Weekly Progress</span>
      </div>

      <div style={styles.dateContainer}>
        <h2 style={styles.dateText}>July 07, 2024</h2>
        <div style={styles.circularProgress}>
          <div style={styles.progressCircle}>
            <span style={styles.progressPercentage}>50%</span>
          </div>
        </div>
      </div>
